...
public class TodoHandler implements BaseHandler {
    ...
    public BaseResponse<TodoRepresentation> addTodo(ActionRequest request) throws DBServiceException, IOException {
    ...
    public BaseResponse<TodoRepresentation> updateTodo(ActionRequest request) throws DBServiceException, IOException, TodoNotFoundException, TodoAssignNotFoundException {
    ...
    public BaseResponse<TodoRepresentation> verifyTodo(ActionRequest request) throws DBServiceException, IOException, TodoNotFoundException, TodoAssignNotFoundException, InconsistentStateException {
    ...
    public BaseResponse<TodoRepresentation> removeTodo(ActionRequest request) throws DBServiceException, IOException, TodoNotFoundException {
        LOGGER.info("[TodoHandler] removeTodo() - request: {}", GsonUtils.convertToString(request));
        TodoRepresentation response = todoServiceHandler.removeTodo(request);
    ...
    public BaseResponse<CsActionRepresentation> getTodos(ActionRequest request) throws DBServiceException, IOException, TodoNotFoundException {
    ...
    public BaseResponse<CsActionRepresentation> getTodoOfUser(UserRequest request) throws DBServiceException, IOException, TodoNotFoundException {
